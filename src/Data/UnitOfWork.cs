...
namespace CommentService.Api.Data
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IVideoCourseRepository _videoCourseRepository;
        ...
        public IVideoCourseRepository VideoCourses
        {
            get
            {
                return _videoCourseRepository ??= new VideoCourseRepository(_dbContext);
            }
        }
